...
class MySQLConnector(object):
    ...
    def __init__(self, host="localhost", user="root", passwd="root", database="earthquake",
                 debug=False):  # Versión 1.0.1
        try:
...
queries = ["call convertEarthquake('2016-06-02 00:01:28.470' ,-16.8394 , -70.4347,	15.46 ,5.2 ,'mb');",
           ...
           "call convertEarthquake('2017-12-24 19:33:20.000' ,-14.1990, -74.3370,	69.70 ,5.0 ,'mb');" # 2017
           ]
magnitudes = [5.2, 5.1, 4.4, 5.2, 4.7, 4.5, 4.7, 4.5, 4.5, 5.0]
